package com.dima.lab8.controller;
...
import com.dima.lab8.R;
import com.dima.lab8.model.Customer;
import com.dima.lab8.model.CustomerList;
import com.dima.lab8.model.db.Database;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void bindButtons() {
        ...
        openFirstActivityButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity(new Intent(MainActivity.this, FirstActivity.class));
            }
        });
        ...
        openSecondActivityButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity(new Intent(MainActivity.this, SecondActivity.class));
            }
        });
    ...
    private void acceptArraySizeDialog(View view) {
        ...
        if (!s.isEmpty()) {
            ...
            if (size > 0) {
                ...
                String t = CURRENT_SIZE_STRING + size;
                mCurrentSizeTextView.setText(t);
                CustomerList.getInstance().deleteCustomers();
    ...
    private AlertDialog createInputCustomerDialog() {
        ...
        builder.setView(view)
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        addCustomer(view);
                        if (CustomerList.getInstance().getSize() != CustomerList.getInstance().getmMaxSize()) {
                            openInputCustomerDialog();
                        }
                    }
                }).setCancelable(false);
